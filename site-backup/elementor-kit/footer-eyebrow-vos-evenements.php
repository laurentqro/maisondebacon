<?php
/* Eyebrow de colonne dans le footer (template Elementor 108363, heading 8f4441e) :
 * « Privé & Événements » -> « Vos Événements » (demande client).
...
$bak = '/tmp/mdb-evfix/footer-108363-eyebrow-' . date('Ymd-His') . '.json';
